      ...
      <div className="max-w-screen-web mx-auto grid grid-cols-2 gap-y-6 lg:grid-cols-4 items-center gap-x-4">
        <div className="flex flex-col lg:flex-row items-center gap-y-3 lg:items-start gap-x-6">
          <div className="min-w-16 w-16 min-h-16 h-16 rounded-full flex items-center justify-center bg-primary">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="min-w-8 min-h-8 w-8 h-8 text-white">
        ...
        <div className="row-start-1 lg:row-start-auto -mt-20 col-span-2 p-6 md:p-10 lg:-mt-32 bg-primary text-white relative flex flex-col items-center lg:items-start">
          ...
          <Link href="/kontakt" className="inline-block mt-4">
            <Button variant="secondary" className="bg-white text-primary hover:bg-white/90">Projekt starten  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={3} stroke="currentColor" className="min-w-4 ml-2 min-h-4 w-4 h-4">

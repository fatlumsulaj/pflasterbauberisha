      ...
      <div className="px-4 md:px-8">
        <div className="max-w-screen-web mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 -mt-20">
          <div className="bg-neutral-900 p-6 md:p-8 lg:p-10 text-white md:col-span-2 md:flex md:items-center md:gap-x-5">
            <img src="https://ik.imagekit.io/inowebagentur/Berisha%20Pflasterbau/tr:w-100/output-onlinepngtools%20(3).png" alt="Glasfaser- & Stromkabel" className='w-16 h-16  max-w-[64px]' />
            <div>
          ...
          <div className="bg-neutral-900 text-white p-6 md:p-8 lg:p-10">
            <img src="https://ik.imagekit.io/inowebagentur/Berisha%20Pflasterbau/tr:w-100/image%20(23).png" alt="Natursteinpflaster" width="64px" height="64px" />
          ...
          <div className="bg-neutral-900 text-white p-6 md:p-8 lg:p-10">
            <img src="https://ik.imagekit.io/inowebagentur/Berisha%20Pflasterbau/tr:w-100/image%20(24).png" alt="Randsteine" width="64px" height="64px" />
          ...
          <div className="bg-neutral-900 text-white p-6 md:p-8 lg:p-10">
            <img src="https://ik.imagekit.io/inowebagentur/Berisha%20Pflasterbau/tr:w-100/image%20(25).png" alt="Verbundpflaster" width="64px" height="64px" />
          ...
          <div className="bg-neutral-900 text-white p-6 md:p-8 lg:p-10">
            <img src="https://ik.imagekit.io/inowebagentur/Berisha%20Pflasterbau/tr:w-100/image%20(26).png" alt="Wege und Einfahrten" width="64px" height="64px" />

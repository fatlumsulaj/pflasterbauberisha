  ...
  return (
    <>
      ...
      <Carousel autoplay autoplayInterval={5000} defaultControlsConfig={{ nextButtonText: <ChevronRight />, prevButtonText: <ChevronLeft />, pagingDotsStyle: { scale: 1.8 }, pagingDotsContainerClassName: "paging-dots"}}>
        ...
        <section
          className={`mt-[70px] background2 bg-black h-[600px] md:h-[700px] flex justify-center items-center text-center padding-container pb-[100px]`}
        >
          <img className="hidden md:block" src="/line-left.png" alt="line" />
          <div className="">
            <p className="paragraph uppercase text-white">WE BUILD YOUR DREAMS</p>
            <h2 className="heading1 text-white">Dein partner fur Pflasterbau</h2>
            <p className="max-w-[600px] text-white paragraph-sm mb-4">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam
              provident, delectus adipisci accusantium, distinctio, rem alias dicta
              nam dolor nobis earum.

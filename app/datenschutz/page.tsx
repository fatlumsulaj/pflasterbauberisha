...
export default function Datenschutz() {
  return (
    <main className="px-4 my-10 md:my-14 lg:my-16 datenschutz">
      <div className="max-w-screen-web mx-auto flex flex-col">
        <h1 className="h1 mb-4">Datenschutz&shy;erkl&auml;rung</h1>
        <h2 className="h2 mt-6">1. Datenschutz auf einen Blick</h2>
        ...
        <h3 className="h3 mt-3">Datenerfassung auf dieser Website</h3>{" "}
        ...
        <h4 className="h4 mt-2">Wie erfassen wir Ihre Daten?</h4>{" "}
        <p className="text-[17px]">
        ...
        <h4 className="h4 mt-2">Wof&uuml;r nutzen wir Ihre Daten?</h4>{" "}
        <p className="text-[17px]">
        ...
        <h3 className="h3 mt-3">Analyse-Tools und Tools von Dritt&shy;anbietern</h3>{" "}
        <p className="text-[17px]">
        ...
        <h2 className="h2 mt-6">2. Hosting</h2>
        <p className="text-[17px]">
          Wir hosten die Inhalte unserer Website bei folgendem Anbieter:
        </p>
        <h3 className="h3 mt-3">Amazon Web Services (AWS)</h3>{" "}
        <p className="text-[17px]">
        ...
        <h3 className="h3 mt-3">Datenschutz</h3>{" "}
        <p className="text-[17px]">
        ...
        <h3 className="h3 mt-3">Hinweis zur verantwortlichen Stelle</h3>{" "}
        <p className="text-[17px]">
        ...
        <p className="text-[17px]">
          Telefon: +49 151 15231645
          <br />
          E-Mail: sherifpflasterbaupassau@googlemail.com
        </p>
        <p className="text-[17px]">
        ...
        <h3 className="h3 mt-3">Speicherdauer</h3>{" "}
        <p className="text-[17px]">
        ...
        <h3 className="h3 mt-3">Empfänger von personenbezogenen Daten</h3>{" "}
        <p className="text-[17px]">
        ...
        <h3 className="h3 mt-3">Recht auf Daten&shy;&uuml;bertrag&shy;barkeit</h3>{" "}
        <p className="text-[17px]">
        ...
        <h3 className="h3 mt-3">Auskunft, Berichtigung und L&ouml;schung</h3>{" "}
        <p className="text-[17px]">
        ...
        <h3 className="h3 mt-3">Recht auf Einschr&auml;nkung der Verarbeitung</h3>{" "}
        <p className="text-[17px]">
        ...
        <h3 className="h3 mt-3">SSL- bzw. TLS-Verschl&uuml;sselung</h3>{" "}
        <p className="text-[17px]">
        ...
        <h2 className="h2 mt-6">4. Datenerfassung auf dieser Website</h2>
        <h3 className="h3 mt-3">Cookies</h3>{" "}
        <p className="text-[17px]">
        ...
        <h3 className="h3 mt-3">Kontaktformular</h3>{" "}
        <p className="text-[17px]">
        ...
        <h3 className="h3 mt-3">Anfrage per E-Mail, Telefon oder Telefax</h3>{" "}
        <p className="text-[17px]">
        ...
        <h2 className="h2 mt-6">5. Plugins und Tools</h2>
        <h3 className="h3 mt-3">Nutzung von Google Analytics</h3>
        <p className="text-[17px]">
          ...
          Werbemaßnahmen zu optimieren. Google Analytics wird uns von Google
          Ireland Limited (Gordon House, Barrow Street, Dublin 4, Irland)
          bereitgestellt. Google verarbeitet die Daten zur Website-Nutzung in
          unserem Auftrag und verpflichtet sich vertraglich zu Maßnahmen, um die
        ...
        <ul className="text-[17px] mb-3">
          <li>Aufgerufene Seiten</li>
          <li>Bestellungen inkl. des Umsatzes und der bestellten Produkte</li>
          <li>
            Die Erreichung von "Website-Zielen" (z.B. Kontaktanfragen und
          ...
          <li>
            Es werden keine persönliche Daten wie Name, Anschrift oder
        ...
        <p className="text-[17px]">
          ...
          Website-Besuchen wiedererkannt werden können. Die aufgezeichneten
          Daten werden zusammen mit der zufallsgenerierten User-ID gespeichert,
          was die Auswertung pseudonymer Nutzerprofile ermöglicht. Diese
          nutzerbezogenen Daten werden automatisch nach 14 Monaten gelöscht.
          ...
          Deaktivierung von Google Analytics unterbinden oder durch das Ablehnen
          der Cookies über unseren Cookie-Einstellungs-Dialog.
        </p>
        <h3 className="h3 mt-3">Google Fonts (lokales Hosting)</h3>{" "}
        <p className="text-[17px]">
